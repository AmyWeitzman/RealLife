...
def buy_car(car):
    ...
    if(player_info.mil_to_college and (player_info.mil_start_college == 0)):  # required to get vehicle, not count as action
        pass
